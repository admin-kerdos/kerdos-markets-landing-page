...
const sliderImages = [
  ...
  },
  {
    ...
    alt: "People discussing product strategy"
  },
  {
  ...
  },
  {
    ...
    alt: "Designer presenting mockups"
  },
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1448932223592-d1fc686e76ea?auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    alt: "Developers pair programming"
  }
];
      ...
      <nav data-state={menuState && "active"} className="group fixed z-20 w-full pt-2">
        ...
        >
          ...
          >
            ...
            <div className="group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border bg-background p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
